...
async function seedRoles() {
  try {
    ...
    const managerEntityTypes = [
      ...
      'DASHBOARD', 'USERS', 'PRODUCTS', 'ORDERS', 'SETTLEMENTS', 'JOURNALS', 'SNAP_RIDE', 'SNAP_RENTAL', 'SNAP_HOME_SERVICES', 'SNAP_REAL_ESTATE', 'AUTHENTICATION',
      ...
      // SNAP Home Services & Real Estate
      'SNAP_HOME_SERVICES', 'SNAP_HOME_SERVICES_PROVIDER_APPLICATIONS', 'SNAP_HOME_SERVICES_PROVIDERS',
      'SNAP_HOME_SERVICES_BOOKINGS', 'SNAP_HOME_SERVICES_CATEGORIES',
      'SNAP_REAL_ESTATE', 'SNAP_REAL_ESTATE_AGENT_APPLICATIONS', 'SNAP_REAL_ESTATE_AGENTS',
      'SNAP_REAL_ESTATE_LISTINGS', 'SNAP_REAL_ESTATE_BOOKINGS',
    ...
    const viewOnlyMainEntities = ['DASHBOARD', 'PRODUCTS', 'ORDERS', 'SETTLEMENTS', 'JOURNALS', 'SNAP_RIDE', 'SNAP_RENTAL', 'SNAP_HOME_SERVICES', 'SNAP_REAL_ESTATE', 'AUTHENTICATION'];
